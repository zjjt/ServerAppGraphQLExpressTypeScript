...
import {duplicateEmail, emailNotValid, emailNotLongEnough, passwordNotLongEnough} from '../utilitaires/errorMessages';
...
describe("Creation of a user", async() => {
    test("check if it can create a user", async() => {
    ...
    test("can't recreate same user in DB and checks if password is crypted", async() => {
    ...
    test("check for bad email and bad password", async() => {
